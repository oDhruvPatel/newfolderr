    ...
    <>
      ...
      >
        ...
        >
                  ...
                  <Education seq={1} classLR="md:text-right md:pr-1" class="left" title="B.E Computer Sci. and Engg. - Spec. AI & ML" timeline="2021-2024" desc={BE}/>
                  <Education seq={2} classLR="md:text-left md:pl-1" class="right" title="Diploma in Computer Engineering" timeline="2018-2021" desc={DI}/>
                  <Education seq={3} classLR="md:text-right md:pr-1 " class="left" title="10th Grade" timeline="2017-2018" desc={board}/>
               </div>
               </div>  
    </>
  )

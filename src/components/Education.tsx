  ...
  return (
    <>
      <div
        ...
        >
          <div className={`md:${props.classLR} md:w-[100%] w-full text-left text-lg font-medium px-4 pt-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-700 to-purple-700`}>
            #{props.seq}
          </div>
          <div

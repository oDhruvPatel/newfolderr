  ...
  return (
    ...
    <div className={` md:w-[80vw] w-[100vw] m-auto bg-white`}>
      <div className={`${props.class} md:w-[50%] w-[90%] md:m-0 m-auto  bg-white flex justify-center items-center flex-col `}> 
         <div className="md:w-[98%] w-full md:text-right text-left text-lg font-medium px-4 py-1 text-transparent bg-clip-text bg-gradient-to-r from-pink-700 to-purple-700">#{props.seq}</div>
         <div className={`md:my-0 md:mx-0 my-4 mx-auto bg-white rounded-xl p-4 md:w-[98%] w-full shadow-md border primary view` }>

    ...
    <>
      <div
        ...
        >
          ...
          <div
            className={`md:my-0 md:mx-0 mb-4 bg-white rounded-xl p-4 md:w-[90%] w-[96%] ml-3 md:ml-0 shadow-md border-slate-300 border primary view transition-all hover:scale-105`}
          >

...
const Experience = () => {
    ...
    return (
    <>
      <h1 className='text-slate-800 flex justify-center items-center text-3xl md:text-center text-center md:text-4xl primary capitalize font-bold  md:py-3 py-2 my-7  '>
             Experience

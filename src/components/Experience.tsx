...
const Experience = () => {
    ...
    <>
      ...
      >
        ...
        >
                  <Education seq={1} classLR="md:text-right md:pr-1" dotLR="md:-right-[10px] md:left-auto -left-[-3.5%]" class="left" title="Backend Developer (Node.js)" timeline="jan 2024 - Apr 2024" desc={Toshal}/>
                  <Education seq={2} classLR="md:text-left md:pl-1"  dotLR="md:-left-[5px] md:right-auto -left-[-3.5%]" class="right" title="Data Analyst" timeline="May 2024 - Present" desc={DA}/>
        </div>
        </div>     
    </>
  )

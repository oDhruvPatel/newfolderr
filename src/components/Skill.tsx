...
const Skill = (props:{list:string[], title:string, bg:string, icon?:ReactElement}) => {
  return (
   <>
      <div className={`${props.bg} border view flex flex-col my-4 md:my-4 md:m-2 md:w-[30%] w-[90%] m-auto text-black shadow-me rounded-xl p-2 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 hover:scale-105 transition-all`}>

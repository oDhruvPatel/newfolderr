...
const Project = (props: {title:string, image:string, desc:string, tech:string[]}) => {
  return (
    <>
      ...
      <div className="view md:w-[30%] h-full w-[90%] md:m-0 m-auto rounded-xl md:px-0 shadow-md border border overflow-hidden my-2 md:my-2 hover:scale-105 transition-all hover:cursor-pointer" onClick={()=>{console.log(props.title)}}>

...
const Project = (props: { title: string; image: ReactElement; desc: string; tech: string[] }) => {
  ...
  return (
    <>
      <div
        id="card-links"
        className="card-links border border-white/10 backdrop-blur-lg view md:w-[30%] h-full w-[90%] md:m-0 m-auto rounded-xl md:px-0 shadow-md overflow-hidden my-2 md:mx-4 md:my-2 transition-all hover:cursor-pointer"
